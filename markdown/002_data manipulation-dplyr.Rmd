...
Pada praktek kali ini kita akan belajar untuk melakukan data manipulation menggunakan Package  ```dplyr```.  Sebelum dapat digunakan, Package ```dplyr``` harus kita install dan load terlebih dulu.
